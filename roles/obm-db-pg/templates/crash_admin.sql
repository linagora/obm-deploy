...
insert into host (host_domain_id, host_name, host_fqdn, host_ip) values (1, '{{ hostvars[groups['syncservers'][0]]['ansible_hostname'] }}', '{{ groups['syncservers'][0] }}', '{{ hostvars[groups['syncservers'][0]] | get_ip(lan_net) }}');
-- A kind of magic --
