...
insert into host (host_domain_id, host_name, host_fqdn, host_ip) values (1, '{{ groups['syncservers'][0] | replace(".", "_") }}', '{{ groups['syncservers'][0] }}', '{{ hostvars[groups['syncservers'][0]] | get_ip(lan_net) }}');
-- A kind of magic --
